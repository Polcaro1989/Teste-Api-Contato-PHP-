...
?>
  ...
  <head>
    <title>Administrador dos e-mails- Pesquisar detalhes de e-mails</title>
      ...
      <div class="content-wrapper">
        <div class="content-header row">
          <div class="content-header-left col-md-10 col-12 mb-2 breadcrumb-new">
            <h3 class="content-header-title mb-0 d-inline-block">Relatório de Contatos P/B Datas</h3>
            <div class="row breadcrumbs-top d-inline-block">
              <div class="breadcrumb-wrapper col-12">
                <ol class="breadcrumb">
                  <li class="breadcrumb-item"><a href="index.html">Dashboard</a>
                  </li>
                  <li class="breadcrumb-item active">Relatório de Contatos P/B Datas
                  </li>
                </ol>
              </div>
            </div>
            ...
            <div class="col-12">
              <div class="card">
                ...
                <div class="card-content collapse show">
                  <h4 align="center" style="font-weight: bold">Relatório de Contatos P/B Datas <?php echo htmlentities($_SESSION['frmdate']); ?> para <?php echo htmlentities($_SESSION['todate']); ?></h4>
                  <p class="px-1">
