...
if (strlen($_SESSION['userlogin']) == 0) :
  ...
  if (isset($_POST['search'])) {
    ...
    if ($sby == "" || $skey == "") {
      $errormsg = "Selecione todos os campos";
    } else {
...
?>
  ...
  <head>
    ...
    <title>Administrador do formulário de e-mails| Selecione a data</title>
            ...
            <div class="row breadcrumbs-top d-inline-block">
              <div class="breadcrumb-wrapper col-12">
                <ol class="breadcrumb">
                  ...
                  <li class="breadcrumb-item active">Pesquisar detalhes de e-mail
                  </li>
                </ol>
              </div>
            </div>
                ...
                <div class="col-12">
                  <div class="card">
                    <div class="card-header">
                      <h4 class="card-title">Pesquisar detalhes de contato</h4>
                    ...
                    <div class="card-content">
                      <div class="card-body">
                          ...
                          <div class="col-xl-6 col-lg-12">
                            <fieldset>
                              ...
                              <div class="form-group">
                                <input type="radio" name="searchby" id="input-radio-11" value="name" checked> Nome
                                <input type="radio" name="searchby" id="input-radio-11" value="phone"> Telefone
                                <input type="radio" name="searchby" id="input-radio-11" value="email"> E-mail
                              </div>
                            </fieldset>
                          </div>
                        </div>
                        ...
                        <div class="row">
                          <div class="col-xl-6 col-lg-12">
                            <button type="submit" name="search" class="btn btn-info btn-min-width mr-1 mb-1">Procurar</button>
                          </div>
                        </div>
                      </div>
                    </div>
