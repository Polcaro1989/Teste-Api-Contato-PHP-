...
?>
  ...
  <head>
    ...
    <title>Atualizar e-mails|D&L construtora</title>
            ...
            <div class="row breadcrumbs-top d-inline-block">
              <div class="breadcrumb-wrapper col-12">
                <ol class="breadcrumb">
                  ...
                  <li class="breadcrumb-item active">Atualizar id de e-mail
                  </li>
                </ol>
              </div>
            </div>
                ...
                <div class="col-12">
                  <div class="card">
                    <div class="card-header">
                      <h4 class="card-title">Atualizar id de e-mailId de e-mail onde você deseja receber notificação por e-mail</h4>
                    ...
                    <div class="card-content">
                      <div class="card-body">
                        ...
                        <div class="row">
                          <div class="col-xl-6 col-lg-12">
                            <button type="submit" name="update" class="btn btn-info btn-min-width mr-1 mb-1">Atualizar e-mail</button>
                          </div>
                        </div>
                      </div>
                    </div>
