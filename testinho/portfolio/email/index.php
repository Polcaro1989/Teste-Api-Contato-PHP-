...
<head>
  <link rel="icon" href="../dashboard/uploads/logo/7313xfile" type="image/x-icon">
...
<body style="background-color:#26296e;" class="vertical-layout vertical-menu-modern 1-column mt-5  menu-expanded fixed-navbar" data-open="click" data-menu="vertical-menu-modern" data-col="1-column">
        ...
        <ul class="nav navbar-nav flex-row">
          ...
          <li class="nav-item">
            <a class="navbar-brand" href="index.html">
              <img src="../dashboard/uploads/logo/1507ufile_x" alt="Logo da empresa" style="width:50%;margin-top:25%;">
      ...
      <div class="navbar-container">
        <div class="collapse navbar-collapse justify-content-end" id="navbar-mobile">
          <ul class="nav navbar-nav">
            <li class="nav-item"><a class="nav-link mr-2 nav-link-label" href="http://localhost:8085/portfolio/index.php"><i class="ficon ft-arrow-left"></i></a></li>
          </ul>
        </div>
      </div>
    </div>
  ...
  <footer class="footer fixed-bottom footer-dark navbar-border navbar-shadow">
    <p class="clearfix blue-grey lighten-2 text-sm-center mb-0 px-2">
      <span class="float-md-left d-block d-md-inline-block">Copyright &copy; 2023 <a class="text-bold-800 grey darken-2" href="" target="_blank">Desencolvedor PHP </a>, Todos os direitos reservados. </span>
      <span class="float-md-right d-block d-md-inline-blockd-none d-lg-block">Desenvolvido por Abraão. <i class="ft-heart pink"></i></span>
    </p>
  </footer>
  <!-- BEGIN VENDOR JS-->
