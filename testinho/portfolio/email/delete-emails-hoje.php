<?php
header("refresh:2;url=todays-contact.php");
        ...
        if ($rowCount > 0) {
            ...
            <body>
                ...
                <script>
                    ...
                    Swal.fire(
                        ...
                        window.location.href = 'todays-contact.php'; // Redirecionar para outra página após a mensagem ser exibida
                    });
                </script>
            </body>
            </html>";
            ...
            <body>
                ...
                <script>
                    ...
                    window.location.href = 'todays-contact.php'; // Redirecionar para outra página após a mensagem de erro ser exibida
                </script>
            </body>
            </html>";
        }
