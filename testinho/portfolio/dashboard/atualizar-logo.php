...
if (isset($_POST['save'])) {
    ...
    if (isset($_FILES["xfile"], $_FILES["ufile_x"], $_FILES["ufile"])) {
        ...
        $stmt = $con->prepare("UPDATE logo SET xfile=:xfile, ufile_x=:ufile_x, ufile=:ufile WHERE id=1");
...
$query = "SELECT * FROM siteconfig WHERE id";
