            ...
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                        <h4 class="mb-sm-0">Todos os serviços:</h4>
                                ...
                                <tbody>
                                    ...
                                    try {
                                        ...
                                        while ($ro = $stmt->fetch(PDO::FETCH_ASSOC)) {
                                            ...
                                            $service_detail = $ro['service_detail'];
                                            $ufile = $ro['ufile'];

                                            echo "<tr>
        <td>
            <img src='uploads/services/$ufile' alt='img' style='max-height:150px;'>
        </td>
        <td>$service_title</td>
        <td>$service_desc</td>
        ...
        <td>
            <div class='dropdown d-inline-block'>
                ...
                <ul class='dropdown-menu dropdown-menu-end'>
                    <li>
                        <a href='editservice.php?id=$id' class='dropdown-item edit-item-btn'>
