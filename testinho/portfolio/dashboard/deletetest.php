...
header("refresh:2;url=testemunha-listar.php");
...
if (isset($_GET['id'])) {
    ...
    $query = "DELETE FROM testimony WHERE id = :todelete";
    ...
    if ($result) {
        ...
        echo "<center>Testemunha deletado com sucesso!<br/>Redirecionando em 2 segundos...</center>";
    } else {
