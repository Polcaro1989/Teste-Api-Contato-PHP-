                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <table id="example" class="table table-bordered dt-responsive nowrap table-striped align-middle" style="width:100%">
                                ...
                                <tbody>
                                    <?php
                                    $q = "SELECT * FROM sobre ORDER BY id DESC";
                                    $stmt = $con->prepare($q);
                                    $stmt->execute();

                                    while ($ro = $stmt->fetch(PDO::FETCH_ASSOC)) {
                                        $id = $ro['id'];
                                        $sobre_stitle = $ro['sobre_stitle'];
                                        $sobre_stext = $ro['sobre_stext'];
                                        $ufile = $ro['ufile'];

                                        echo "<tr>
                                          <td>
                                              <img src='uploads/sobre/$ufile' alt='img' style='max-height:150px;'>
                                          </td>
                                          <td>
                                              $sobre_stitle
                                          </td>
                                          ...
                                          <td>
                                              <div class='dropdown d-inline-block'>
                                                  ...
                                                  <ul class='dropdown-menu dropdown-menu-end'>
                                                      <li>
                                                          <a href='editar-sobre.php?id=$id' class='dropdown-item edit-item-btn'>
                                                              <i class='ri-pencil-fill align-bottom me-2 text-muted'></i> Edit
                                                          </a>
                                                      </li>
                                                      <li>
                                                          <a href='delete-sobre.php?id=$id' class='dropdown-item remove-item-btn'>
